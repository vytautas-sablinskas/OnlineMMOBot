...
class Initializer:
    ...
    def initialize_user_class(user_credentials_path=FilePaths.CREDENTIALS):
    ...
    def initialize_discord_class(discord_credentials_path=FilePaths.DISCORD_CREDENTIALS):
